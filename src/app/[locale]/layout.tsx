    ...
    keywords:
      locale === "en"
        ? [
            ...
            "Clinica Hispana Nueva Salud Lawndale",
            "medical center Houston",
            "Latino clinic Houston",
            "primary care doctor Houston",
            "Spanish speaking doctor Houston",
            "family medicine Houston",
            "immigration exam Houston",
...
export default async function LocaleLayout({ children, params }: Props) {
  ...
  return (
    ...
    >
      <head>
        {/* Marca html.js antes del primer pintado: las animaciones de scroll
            solo ocultan contenido cuando hay JS (ver .animate-on-scroll). */}
